...
public class AccessEntriesFromTreeMapExample {
    public static void main(String[] args) {
        ...
        Integer id1 = 1004; 
        String getid = employees.remove(id1);
        if(getid != null) {
            System.out.println("Removed (" + employees +" => " + getid + ") from the TreeMap. New TreeMap " +employees );
        } else {
            System.out.println(employees + " does not exist, or it is mapped to a null value");
        }
